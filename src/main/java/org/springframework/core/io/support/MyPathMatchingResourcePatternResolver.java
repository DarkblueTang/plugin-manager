...
public class MyPathMatchingResourcePatternResolver implements ResourcePatternResolver {
    ...
    static {
        try {
            ...
            Class<?> fileLocatorClass = ClassUtils.forName("org.eclipse.core.runtime.FileLocator",
                    MyPathMatchingResourcePatternResolver.class.getClassLoader());
     ...
     */
    public MyPathMatchingResourcePatternResolver() {
     ...
     * @see org.springframework.core.io.DefaultResourceLoader
     */
    public MyPathMatchingResourcePatternResolver(@Nullable ClassLoader classLoader) {
    ...
    protected Set<Resource> doFindAllClassPathResources(String path) throws IOException {
        ...
        MyClassLoader myClassLoader = MyClassLoader.getMyClassLoader(MyPathMatchingResourcePatternResolver.class.getClassLoader());
        resourceLoader = new DefaultResourceLoader(myClassLoader);

        Enumeration<URL> resourceUrls = myClassLoader.getResources(path);
